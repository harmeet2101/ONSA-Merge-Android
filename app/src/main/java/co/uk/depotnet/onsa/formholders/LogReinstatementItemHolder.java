...
public class LogReinstatementItemHolder extends RecyclerView.ViewHolder {
    public View view;
    public TextView txtNoticeReferenceValue;
    public TextView txtNoticeAddressValue;
    ...
    public LogReinstatementItemHolder(@NonNull View itemView) {
        super(itemView);
        this.view = itemView;
        this.txtNoticeReferenceValue = itemView.findViewById(R.id.txt_notice_ref_value);
        this.txtNoticeAddressValue = itemView.findViewById(R.id.txt_notice_address_value);
